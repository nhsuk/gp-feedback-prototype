module.exports = function (input, req) {
  input.reviews = [
    {
      ...
      userReview: 'Having had to use your services \n\n twice in one week your staff have been nothing but outstanding. The reception team were very reassuring, kind, helpful and considerate while your clinicians were equally also. Seen within hours of requesting a (non urgent) appointment. Can’t promote your service enough. Very grateful. Thank you.',
    ...
    },
    {
      ...
      userReview: 'I’ve been a patient for about 8 years, due to moving out of the area I have to leave the practice and am devastated. I’ve only ever received first quality care and would recommend it to anyone. Yes there have been times when things haven’t been perfect but that’s hardly surprising given the pressure that I’m sure all doctors surgeries are under. What matters is that they get the main things right, it’s easy to make an appointment, the reception, doctors and nurses are all polite, courteous and really listen and try to help you. The doctors always ensure your appointment is at the surgery location that suits you best. You always get a telephone consultation before a face to face appointment which I’m sure some people wouldn’t like but I’ve found this to be really helpful as you get to speak to a doctor about your issue and if they can help put your mind at ease or prescribe you medication without seeing you they will, they have also never denied me a face to face appointment when it was needed. If I didn’t have to leave here I wouldn’t, even with the greater distance to travel.',
  ...
  input.reviews.unshift({
    screenName: req.session.validated.screenName,
